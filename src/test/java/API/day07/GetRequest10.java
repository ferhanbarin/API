...
public class GetRequest10 extends Dummy {

/*
    http://dummy.restapiexample.com/api/v1/employees URL'ine bir istek gönderildiğinde dönen response'un
    Status kodunun 200,
...
*/
    ...
    public void test() {
        ...
        // Groovy dili JAVA'nin alt dilidir. Biz bu dil yardimi ile Loop kullanmadan gelen response'daki degerleri bir sarta bagli olarak listeye yazdirabiliyoruz.
